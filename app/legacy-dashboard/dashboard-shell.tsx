...
const navGroups = [
  {
    label: "OVERVIEW",
    items: [
      { href: "/legacy-dashboard", label: "대시보드", icon: LayoutDashboard },
    ],
  },
  {
    label: "INFRASTRUCTURE",
    items: [
      { href: "/legacy-dashboard/workers", label: "PC 관리", icon: Server },
      { href: "/legacy-dashboard/devices", label: "디바이스", icon: Smartphone },
      { href: "/legacy-dashboard/proxies", label: "프록시", icon: Shield },
      { href: "/legacy-dashboard/network", label: "네트워크", icon: Globe },
    ],
  },
  {
    label: "CONTENT",
    items: [
      { href: "/legacy-dashboard/channels", label: "채널 관리", icon: Tv },
      { href: "/legacy-dashboard/content", label: "콘텐츠 등록", icon: Upload },
      { href: "/legacy-dashboard/tasks", label: "작업 / 대기열", icon: ListOrdered },
    ],
  },
  {
    label: "AUTOMATION",
    items: [
      { href: "/legacy-dashboard/scripts", label: "스크립트", icon: FileText },
      { href: "/legacy-dashboard/workflows", label: "워크플로우", icon: ListOrdered },
      { href: "/legacy-dashboard/presets", label: "프리셋", icon: Zap },
      { href: "/legacy-dashboard/adb", label: "ADB 콘솔", icon: Terminal },
    ],
  },
  {
    label: "SYSTEM",
    items: [
      { href: "/legacy-dashboard/settings", label: "설정", icon: Settings },
      { href: "/legacy-dashboard/logs", label: "로그", icon: FileText },
      { href: "/legacy-dashboard/errors", label: "에러", icon: AlertTriangle },
    ],
  },
];
    ...
    <SidebarProvider>
      <Sidebar className="border-r border-sidebar-border bg-sidebar">
        <SidebarHeader className="px-4 py-5">
          <Link href="/legacy-dashboard" className="flex items-center gap-2.5">
