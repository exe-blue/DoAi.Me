...
| **High** | `docs/CURRENT_DEV_SUMMARY.md` (current state), `docs/API_REFERENCE.md`, `docs/AGENT_SERVER_SPEC.md`, `docs/OPERATIONS_GUIDE.md`, `docs/INCIDENT_RESPONSE.md`, `docs/PC_SETUP_CHECKLIST.md`, `docs/MENU_API_MAP.md`, `docs/QUEUE_AND_TASKS_FLOW.md`, `docs/adrs/*` (6 ADRs + README), `docs/adr/*` (7 ADRs + README), `docs/production-migrations/` (README + SQL), `docs/qa-reports/README.md` |
