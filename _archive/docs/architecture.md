# DoAi.Me 아키텍처 (archived)

**Archived**: 2026-02-28. This doc described the legacy flow (VideoDispatcher, jobs/job_assignments). Current flow: task_queue → tasks → task_devices. See **docs/CURRENT_DEV_SUMMARY.md** and **docs/architecture-five-layer-pipeline.md**.
...
- 경로: `C:\Users\[user]\doai-agent\` (또는 farm_agent 등, FOLDER_STRUCTURE.md 참고)
- Node.js: CommonJS
