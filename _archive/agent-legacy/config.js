...
// PC_NUMBER is optional: agent auto-registers via DB and stores in agent/data/pc.json
const requiredEnv = [
...
class AgentConfig extends EventEmitter {
  constructor() {
    ...
    // Optional fallback for tests; production uses getOrRegisterPcId() + agent/data/pc.json
